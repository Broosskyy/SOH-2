...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BA17t9-a.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-D9m9x3qt.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-C2MQ3cml.js");
		return { get "default"() {
			return m["default"];
		} };
	},
