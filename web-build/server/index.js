...
function getDraftSecret() {
	return "5104e310-9680-42dd-b831-50136fe76f9e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "dfb17f9a-a089-4938-b1ee-8433ec26f7b3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "dfb17f9a-a089-4938-b1ee-8433ec26f7b3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "dfb17f9a-a089-4938-b1ee-8433ec26f7b3",
		rootBoundaryId
	});
}
/**
