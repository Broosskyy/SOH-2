globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-DcYXFTDo.js","assets/page-CTwAWNIK.js","assets/threeRenderer-BdaIhHsr.js","assets/layout-segment-context-CQEwPDCE.js"];
...
function getDraftSecret() {
	return "09f09c7c-f306-4a47-8c83-d9e118ada85f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "348d8f4a-a0fb-4032-ace5-0a43eafe53b0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "348d8f4a-a0fb-4032-ace5-0a43eafe53b0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "348d8f4a-a0fb-4032-ace5-0a43eafe53b0",
		rootBoundaryId
	});
}
/**
