globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-mEJHIq05.js","assets/page-CKTCFHrE.js","assets/threeRenderer-BYsC_73u.js","assets/layout-segment-context-Da0YSfyE.js"];
...
function getDraftSecret() {
	return "60a57cd0-123b-4714-99f3-9e6587f3e927";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "70645f67-d1e8-454e-b7c7-8b29423ece50";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "70645f67-d1e8-454e-b7c7-8b29423ece50") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "70645f67-d1e8-454e-b7c7-8b29423ece50",
		rootBoundaryId
	});
}
/**
