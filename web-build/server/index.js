globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-DQ2_T-vl.js","assets/page-D4-dSsO9.js","assets/threeRenderer-e6v0Q-Ai.js","assets/layout-segment-context-BAZu45D2.js"];
...
function getDraftSecret() {
	return "11cd1feb-657e-42a5-8b19-d0dd5e7ba01c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a722984f-a196-433c-928b-ceb25191b0cd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a722984f-a196-433c-928b-ceb25191b0cd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a722984f-a196-433c-928b-ceb25191b0cd",
		rootBoundaryId
	});
}
/**
