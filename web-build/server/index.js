globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-ksKkSjup.js","assets/page-BOSrCXm7.js","assets/threeRenderer-Pem6aFw0.js","assets/layout-segment-context-Q_n2j0Ha.js"];
...
function getDraftSecret() {
	return "fb025e43-635b-4fe8-b7e7-a044abd01938";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "58e4b162-d4c1-4eef-a346-98dd14d55b67";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "58e4b162-d4c1-4eef-a346-98dd14d55b67") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "58e4b162-d4c1-4eef-a346-98dd14d55b67",
		rootBoundaryId
	});
}
/**
