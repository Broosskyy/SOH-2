globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-HHstTBU5.js","assets/page-J2JXHZL-.js","assets/threeRenderer-Z6w1_jIx.js","assets/layout-segment-context-Dpsvbqc5.js"];
...
function getDraftSecret() {
	return "3758a24f-8304-46f5-9b79-85ad8f6399cb";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1a30f282-b96f-4410-bf66-763b68fbabed";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1a30f282-b96f-4410-bf66-763b68fbabed") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1a30f282-b96f-4410-bf66-763b68fbabed",
		rootBoundaryId
	});
}
/**
