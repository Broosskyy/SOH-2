globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-PFtAeUL9.js","assets/page-CzHOW3q9.js","assets/threeRenderer-DqhANq9P.js","assets/layout-segment-context-Diq1Xy0o.js"];
...
function getDraftSecret() {
	return "95ba187a-4cb1-41fe-a948-da9a6df6dc16";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c0fe9e64-8b3e-4262-9eb5-da79d5347fd3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c0fe9e64-8b3e-4262-9eb5-da79d5347fd3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c0fe9e64-8b3e-4262-9eb5-da79d5347fd3",
		rootBoundaryId
	});
}
/**
