globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/shipVisuals-DqHkuA3W.js","assets/page-8EFhNQyL.js","assets/threeRenderer-bwALmAs1.js","assets/layout-segment-context-C4v4rvqI.js"];
...
function getDraftSecret() {
	return "176ffa88-750d-4e9e-8e45-7679e798ec3f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7d9e5aa6-5ec8-4970-9ae4-0a9a7d5419cc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7d9e5aa6-5ec8-4970-9ae4-0a9a7d5419cc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7d9e5aa6-5ec8-4970-9ae4-0a9a7d5419cc",
		rootBoundaryId
	});
}
/**
